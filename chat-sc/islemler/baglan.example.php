<?php
/**
 * Örnek veritabanı ayarı — bu dosyayı `baglan.php` olarak kopyalayın:
 *   cp baglan.example.php baglan.php
 * Ardından host, veritabanı adı, kullanıcı ve şifreyi düzenleyin.
 * `baglan.php` depoya eklemek istemiyorsanız .gitignore'a ekleyin.
 */
